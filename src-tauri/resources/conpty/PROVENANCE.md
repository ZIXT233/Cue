...
Bundled files: `conpty.dll`, `OpenConsole.exe` (win-x64).
...
- Both binaries were verified `Valid` and signed by
...
2. Extract `runtimes/win-x64/native/conpty.dll` and
   `build/native/runtimes/x64/OpenConsole.exe` into this directory.
