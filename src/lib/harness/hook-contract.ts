...
/**
 * A harness's own event names are read in exactly one place — `meaningOf` in the
 * harness signal path — and turn straight into what a card does with them. There is
