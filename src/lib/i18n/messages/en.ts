...
export const enLocale: LocalePlugin = {
  ...
  label: "English",
  messages: {
    "harness.error.HARNESS_UNSUPPORTED": "This CLI is not supported by Cue.",
    ...
    "harness.error.HARNESS_CLI_MISSING": "Could not find {detail} on this machine. Cue checked your shell environment and common install locations.",
    "harness.error.HARNESS_CLI_MISSING_REMOTE": "Could not find {detail} on the remote host. Cue checked the login shell's PATH; install the CLI there first.",
    ...
    "harness.error.HARNESS_CONFIG_UNREADABLE": "Could not read the CLI's existing config, so Cue left it untouched.",
    "harness.error.HARNESS_HOOKS_FOREIGN": "An existing hook entry under this name does not belong to Cue, so nothing was overwritten.",
    "harness.error.HARNESS_HOOKS_INVALID": "The existing hooks configuration could not be parsed, so Cue left it untouched.",
    ...
    "harness.titleProbe": "Using terminal status. Enable Cue hooks in Codex /hooks.",
    ...
    "external.hint": "Reported by {name}; sessions outside Cue cannot be continued here",
    ...
    "queue.Card Queue 主页": "Cue home",
    "queue.Pi 设置": "Cue settings",
    ...
    "queue.removeWorkspaceDescription": "“{name}” will be removed from Cue's workspace list and card queue. Its directory and existing conversation files will not be deleted.",
    ...
    "queue.打开 Pi Web 的完整工作区：文件、终端、统计": "Open the full Cue workspace: files, terminal and statistics",
  ...
  "settings.notificationSystemSettingsOpened": "Cue notifications are disabled in macOS. System Settings has been opened; select Cue.",
  ...
  "settings.notificationSystemSettingsFailed": "System notifications are not enabled. Allow Cue notifications in macOS System Settings.",
  "settings.openNotificationSettings": "Open notification settings",
    "settings.diagnostics": "Diagnostics",
    "settings.debugLogging": "Detailed debug logging",
    "settings.debugLoggingDescription": "Write extra SSH, hook, and terminal details to ~/.cue/logs. A card’s Logs button always saves a report and opens the file.",
    ...
    "settings.generalDescription": "Choose how Cue looks and which language it uses.",
    ...
    "settings.terminalBackgroundDescription": "Solarized cream or teal for the terminal canvas. Running CLIs are told the new colors over the same session. On Windows the canvas only stays Campbell black while the bundled modern ConPTY is unavailable.",
    ...
    "settings.externalSessions": "External Sessions",
    "settings.externalSessionsDescription": "Capture AI sessions running in external terminals, desktop apps, or editor extensions, and notify you when ready or waiting for attention.",
    "settings.externalSessionsSubtitle": "Configure external session ingress per harness",
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable Cue built-in sub-agents",
    "agents.builtInDescription": "Provides Cue's integrated Agent tools and disables a conflicting pi-subagents extension.",
    ...
    "appUpdate.releaseNotes": "Cue v{version} is available. View release notes",
    ...
    "terminal.progress.step3": "Waiting",
    "terminal.progress.step3Desc": "Channel ready, waiting for initial terminal output…",
