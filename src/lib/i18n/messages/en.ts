...
export const enLocale: LocalePlugin = {
  ...
  "settings.openNotificationSettings": "Open notification settings",
    ...
    "settings.externalNoticesMasterDescription": "Master switch, off by default. External sessions are only captured while this is on; per-harness switches take effect only when it is enabled.",
